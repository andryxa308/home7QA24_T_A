...
public class Test {
    ...
    public void positiveRegistrationTest()  {
        ...
        WebElement addToCardButton = driver.findElement(By.cssSelector("#add-to-cart-sauce-labs-bike-light"));
        ...
        Assert.assertEquals("Sauce Labs Bike Light", cartItemName.getText());

        WebElement cartItemPrice = driver.findElement(By.cssSelector(".inventory_item_price"));
        Assert.assertEquals("$9.99", cartItemPrice.getText());
